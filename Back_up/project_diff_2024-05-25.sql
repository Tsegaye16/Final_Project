...
--
-- Table structure for table `backup_sample`
--

DROP TABLE IF EXISTS `backup_sample`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `backup_sample` (
  `idbackup_sample` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`idbackup_sample`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `backup_sample`
--

LOCK TABLES `backup_sample` WRITE;
/*!40000 ALTER TABLE `backup_sample` DISABLE KEYS */;
/*!40000 ALTER TABLE `backup_sample` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `note` (
  `id` int NOT NULL AUTO_INCREMENT,
  `poster_id` int NOT NULL,
  `poster_role` varchar(45) DEFAULT NULL,
...
INSERT INTO `note` VALUES (7,9,'Instructor','linked-lists','goood'),(16,13,'Student','queue','ድፍስግ'),(17,9,'Instructor','queue','ጅላጅል ዝም ብለህ አትጃጃል'),(22,9,'Instructor','bst','sample about Binary Search Tree'),(27,13,'Student','graph','DFDGSD'),(29,13,'Student','merge_sort','yhjhkjl'),(30,13,'Student','merge_sort',';jlk hjl;k\'mgkj'),(31,13,'Student','merge_sort','djfok\'sdlre'),(32,9,'Instructor','bubble_sort','sample note about bubble sort.'),(35,13,'Student','bubble_sort','1. good news'),(37,13,'Student','bubble_sort','€ good bell gonder'),(59,9,'Instructor','linked-list','<pre class=\"ql-syntax\" spellcheck=\"false\">const sum = (a, b) =&gt; {\n    return a + b;\n}\n</pre>'),(60,9,'Instructor','linked-list','<pre class=\"ql-syntax ql-indent-2\" spellcheck=\"false\">ገነት አንዷአለም\nጸጋዬ አበዋ\nክፍሌ አስረስ\n</pre>'),(61,9,'Instructor','array','<p>ግድግ hfhjgj</p>'),(62,13,'Student','hash_table','<p>goooooooood</p>'),(64,9,'Instructor','graph','<p>sample test for null role</p>'),(66,77,NULL,'hash_table','<p>ffffffffffffffffffffffffff</p>'),(69,13,'Student','array','<p>wertyuioikmlp</p>'),(70,9,'Instructor','array','<p>stack is alinear algorithm</p>'),(71,12,'Instructor','hash_table','<p>Sample instructor 2</p>'),(72,9,'Instructor','hash_table','<p>sample instructor 1</p>'),(73,13,'Student','linked-list','<p>thank you</p>');
...
INSERT INTO `quiz` VALUES (43,12,'Tsegaye','alx sample'),(45,12,'SAMLE','GK;LU;L'),(46,12,'stack','stack question'),(47,12,'stack','some question');
...
-- Dump completed on 2024-05-25 19:32:17
