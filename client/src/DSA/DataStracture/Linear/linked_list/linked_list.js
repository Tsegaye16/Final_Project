        ...
        <Box sx={useStyles.section}>
          <Box sx={useStyles.root}>
            ...
            <Typography variant="body1" sx={useStyles.paragraph}>
              ...
              collections of data. Array is the most common data structure used
              to store collections of elements. Arrays are convenient to declare
              and provide the easy syntax to access any element by its index
              number. Once the array is set up, access to any element is
              convenient and fast. The disadvantages of arrays are:
              <ul>
                <li>
              ...
              necessary.
              <br />
              <br />A linked list is a non-sequential collection of data items.
              It is a dynamic data structure. For every data item in a linked
              list, there is an associated pointer that would give the memory
              ...
              <ol>
                <li>
                  Linked lists are dynamic data structures. i.e., they can grow
                  or shrink during the execution of a program.
                </li>
                <li>
                  Linked lists have efficient memory utilization. Here, memory
                  isnot preallocated. Memory is allocated whenever it is
                  required and it is de-allocated (removed) when it is no longer
                  needed.
                </li>
                <li>
                  Insertion and Deletions are easier and efficient. Linked lists
                  provide flexibility in inserting a data item at a specified
                  position and deletion of the data item from the given
                  position.
                </li>
                <li>
                  ...
                  <ul>
                    <li style={{ fontSize: "29px" }}>
                      ...
                      <Typography>
                        ...
                        important to find the link. If the link is empty then
                        the new node is inserted as the head of the link, and
                        when the new node is added to an existing link the new
                        node replaces it as the head of the link.
                        <Typography sx={useStyles.subTitle}>
    ...
    head=temp;
                    ...
                    <li style={{ fontSize: "29px" }}>
                      ...
                      <Typography>
                        ...
                        access all the nodes present to find the endpoint. In
                        case the list is empty the inserted node acts as both
                        the first and the last node of the link.
                        <Typography sx={useStyles.subTitle}>
                    ...
                    <li style={{ fontSize: "29px" }}>
                      ...
                      <Typography>
                        When inserting at any given position, the link is
                        accessed to find the point where the node is to be
                        added. The new node is inserted after the given
                        position. If the address is not given to the previous
                        node, you can traverse the link to find the desired
                        point.
                        <Typography sx={useStyles.subTitle}>
        ...
        void insert_POS(Node *head,int pos,int val)
        {
          ...
          for(int i=0;i<pos-2;i++)
            ...
            temp->next=temp1;
                ...
                <br />
                <Typography>
                  Another primitive operation that can be done in a singly
                  linked list is the deletion of a node. Memory is to be
                  released for the node to be deleted. A node can be deleted
