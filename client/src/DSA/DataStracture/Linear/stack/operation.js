    ...
    <div className="Stack">
      <div id="StackContainer">
        <div id="infostack">
          ...
          <div>
            <input type="text" placeholder="Add a element" id="pushInput" className="input-element"/>
            <button id="pushButton" onClick={push} className="stack-button">
              Push
            </button>
          </div>
          <div>
            <p></p>
            <button id="popButton" onClick={pop} className="stack-button">
              Pop
            </button>
          </div>
          <div id="varStack">
