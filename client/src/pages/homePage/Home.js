  ...
  return (
    <div className='main-home'>
      <div className='NavBar'>
        <NavBar isUser={isUser} icon={icon} toggleSidebar={toggleSidebar} userData={userData} />
      </div>
      <div className='main-body'>
        ...
        <div className="main-body-part" style={{ marginLeft: `${sidebarWidth}px`, width: '100%', position: 'relative' }}>
          ...
          <div style={{ position: 'fixed', right: '20px', bottom: '60px', zIndex: 9999 }}>
          <Typography
                variant="caption"
                component="div"
                color="textSecondary"
                sx={{ position: 'absolute', bottom: '50%', right: '50%', transform: 'translate(-50%, -50%)' }}
              >
                {Math.round(progress)}%
              </Typography>
            <CircularProgress
